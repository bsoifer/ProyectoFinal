...
tiendas_fuera_diagonal <- resultado_m1_m2 %>% filter(cluster != predicted_cluster & cluster != 0)
tiendas_diagonal <- resultado_m1_m2 %>% filter(cluster == predicted_cluster & predicted_cluster != 0)
